...
And Network Analyser has NO device corresponding to that identifier
...
Then the response is a 404 result
...
Given A device identified as [<ServiceSpecCharacteristic.Router-HostName>] has failed and raised a Network Event that is available in Netcool
And Network Analyser has a device corresponding to that identifier and this is associated to the resource facing service [<ResourceFacingeService.Id>]
...
Given A device identified as [<ServiceSpecCharacteristic.Router-HostName>] has failed and raised a Network Event that is available in Netcool
And Network Analyser has a device corresponding to that identifier and this is linked to a single resource facing service [<ResourceFacingeService.Id>]
...
Given A device identified as [<ServiceSpecCharacteristic.Router-HostName>] has failed and raised a Network Event that is available in Netcool
And Network Analyser has a device corresponding to that identifier and this is linked to a multiple resource facing services identified as [<ResourceFacingeService.Id>]
